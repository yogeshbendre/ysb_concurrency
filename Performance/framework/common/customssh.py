...
class SSHProcess(multiprocessing.Process):
   ...
   def __init__(self, cmd, host='10.172.109.40', user='root',
                pwd='Admin!23', timeout=900, queue=None, errQueue=None,
                xterm=False):
...
def RunCmdOverSSH(cmd, host, user,pwd, timeout=300, xterm=False):
