...
newestVersions.Add("rbd.version.version5")
stableVersions.Add("rbd.version.version5")
publicVersions.Add("rbd.version.version5")
dottedVersions.Add("rbd.version.version5")
...
CreateManagedType("rbd.CustomCertificateStore", "RbdCustomCertificateStore", "vmodl.ManagedObject", "rbd.version.version5", None, [("addCertificate", "AddCertificate", "rbd.version.version5", (("hostId", "string", "rbd.version.version5", 0, None),("certificate", "string", "rbd.version.version5", 0, None),("key", "string", "rbd.version.version5", 0, None),("force", "boolean", "rbd.version.version5", F_OPTIONAL, None),), (0, "void", "void"), "AutoDeploy.Rule.Create", ["rbd.fault.CustomCertificateExistsFault", "rbd.fault.InvalidCertificateFault", ]), ("getCertificates", "GetCertificates", "rbd.version.version5", (), (F_OPTIONAL, "rbd.CustomCertificateStore.CustomCertificateEntry[]", "rbd.CustomCertificateStore.CustomCertificateEntry[]"), None, None), ("removeCertificatesById", "RemoveCertificatesById", "rbd.version.version5", (("certificateIds", "int[]", "rbd.version.version5", 0, None),), (0, "void", "void"), "AutoDeploy.Rule.Delete", None), ("removeCertificatesByHostId", "RemoveCertificatesByHostId", "rbd.version.version5", (("hostIds", "string[]", "rbd.version.version5", 0, None),), (0, "void", "void"), "AutoDeploy.Rule.Delete", None)])
CreateDataType("rbd.CustomCertificateStore.CustomCertificateEntry", "RbdCustomCertificateStoreCustomCertificateEntry", "vmodl.DynamicData", "rbd.version.version5", [("key", "int", "rbd.version.version5", 0), ("hostId", "string", "rbd.version.version5", 0), ("expirationTime", "vmodl.DateTime", "rbd.version.version5", 0), ("timeCreated", "vmodl.DateTime", "rbd.version.version5", 0), ("lastModified", "vmodl.DateTime", "rbd.version.version5", 0), ("associatedHostName", "string", "rbd.version.version5", F_OPTIONAL)])
...
CreateManagedType("rbd.Rule", "Rule", "vmodl.ManagedObject", "rbd.version.version1", [("spec", "rbd.Rule.RuleSpec", "rbd.version.version1", 0, None), ("metadata", "rbd.Rule.RuleMetadata", "rbd.version.version1", 0, None), ("editable", "boolean", "rbd.version.version1", F_OPTIONAL, None)], [("retrieveSpec", "RetrieveRuleSpec", "rbd.version.version1", (), (0, "rbd.Rule.RuleSpec", "rbd.Rule.RuleSpec"), None, None), ("retrieveMetadata", "RetrieveRuleMetadata", "rbd.version.version1", (), (0, "rbd.Rule.RuleMetadata", "rbd.Rule.RuleMetadata"), None, None), ("retrieveEditable", "RetrieveRuleEditable", "rbd.version.version1", (), (F_OPTIONAL, "boolean", "boolean"), None, None), ("destroy", "DestroyRule", "rbd.version.version1", (), (0, "void", "void"), "AutoDeploy.Rule.Delete", None), ("updateMetadata", "UpdateRuleMetadata", "rbd.version.version1", (("meta", "rbd.Rule.RuleMetadata", "rbd.version.version1", 0, None),), (0, "void", "void"), "AutoDeploy.Rule.Edit", ["rbd.fault.InvalidRuleName", "rbd.fault.DuplicateName", ]), ("updateSpec", "UpdateRuleSpec", "rbd.version.version1", (("ruleSpec", "rbd.Rule.RuleSpec", "rbd.version.version1", 0, None),("force", "boolean", "rbd.version.version3", F_OPTIONAL, None),), (0, "void", "void"), "AutoDeploy.Rule.Edit", ["rbd.fault.InvalidRuleSpecFault", "rbd.fault.ObjectIsNotEditable", ]), ("updateSpecWithTransform", "com.vmware.rbd.UpdateSpecWithTransform_Task", "rbd.version.version3", (("ruleSpec", "rbd.Rule.RuleSpec", "rbd.version.version3", 0, None),("itemsToBeConverted", "string[]", "rbd.version.version3", 0, None),("force", "boolean", "rbd.version.version3", F_OPTIONAL, None),("noSignatureCheck", "boolean", "rbd.version.version3", F_OPTIONAL, None),), (0, "vim.Task", "void"), "AutoDeploy.Rule.Edit", None)])
...
CreateDataType("rbd.fault.CustomCertificateExistsFault", "rbd1FaultCustomCertificateExistsFault", "vim.fault.ExtendedFault", "rbd.version.version5", None)
...
CreateDataType("rbd.fault.InvalidCertificateFault", "rbd1FaultInvalidCertificateFault", "vim.fault.ExtendedFault", "rbd.version.version5", None)
